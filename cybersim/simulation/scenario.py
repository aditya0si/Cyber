...
class CredentialCompromiseScenario:
    ...
    def start(self, delay: float = 1.0, on_event=None):
        self.reset()
        stages = [
    ...
    def _stage_1_brute_force(self) -> list[CanonicalEvent]:
        ...
        for i in range(3):
            events.append(CanonicalEvent(
                ...
                actor="unknown",
                raw_context={"attempt": i + 1, "reason": "invalid_credentials", "raw_type": "auth.attempt", "subtype": "unsanitized_auth_failure_burst", "source_node_id": "attacker_192.168.1.100"}
            ))
        return events
    ...
    def _stage_2_account_compromise(self) -> list[CanonicalEvent]:
        return [CanonicalEvent(
            ...
            raw_context={"auth_method": "password", "raw_type": "auth.success", "subtype": "auth_success_after_burst", "source_node_id": "attacker_192.168.1.100"}
        )]
    ...
    def _stage_4_db_access(self) -> list[CanonicalEvent]:
        return [CanonicalEvent(
            ...
            actor="admin_service_account",
            raw_context={"query": "SELECT * FROM users", "raw_type": "db.query", "subtype": "exfil_candidate_query", "source_node_id": "attacker_192.168.1.100"}
        )]
